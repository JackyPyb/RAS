...
void protobuf_AssignDesc_FwmRcProtocol_2eproto() {
  ...
  Register_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(Register));
  EachModuleResourceInfo_descriptor_ = file->message_type(6);
  ...
  RequestStartSlave_descriptor_ = file->message_type(7);
  ...
  RequestStartSlaveAck_descriptor_ = file->message_type(8);
  static const int RequestStartSlaveAck_offsets_[1] = {
  ...
  RequestTaskResource_descriptor_ = file->message_type(9);
  ...
  RequestTaskResourceAck_descriptor_ = file->message_type(10);
  static const int RequestTaskResourceAck_offsets_[1] = {
  ...
  ReturnTaskResource_descriptor_ = file->message_type(11);
  ...
  StopModule_descriptor_ = file->message_type(12);
  ...
  StopModule_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(StopModule));
  StopModuleAck_descriptor_ = file->message_type(13);
  static const int StopModuleAck_offsets_[1] = {
  ...
  HeartBeatInfo_descriptor_ = file->message_type(14);
  ...
  CloseFrameworkInstanceInfo_descriptor_ = file->message_type(15);
...
void protobuf_AddDesc_FwmRcProtocol_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ntry\030\003 \001(\0132\026.FwmRcProto.NetAddress\"\211\001\n\026E"
    "achModuleResourceInfo\022\031\n\021start_module_na"
    "me\030\001 \002(\t\022\n\n\002ip\030\002 \002(\t\022/\n\rresource_info\030\003 "
    "\001(\0132\030.FwmRcProto.ResourceInfo\022\027\n\017listen_"
    "port_num\030\004 \001(\r\"\350\001\n\021RequestStartSlave\022B\n\027"
    "framework_instance_info\030\001 \002(\0132!.FwmRcPro"
    "to.FrameworkInstanceInfo\022\026\n\016self_module_"
    "id\030\002 \002(\r\022F\n\032start_module_resource_info\030\003"
    " \003(\0132\".FwmRcProto.EachModuleResourceInfo"
    "\022/\n\017FWM_net_address\030\004 \001(\0132\026.FwmRcProto.N"
    "etAddress\")\n\024RequestStartSlaveAck\022\021\n\tmod"
    "ule_id\030\001 \003(\r\"\306\001\n\023RequestTaskResource\022B\n\027"
    "framework_instance_info\030\001 \002(\0132!.FwmRcPro"
    "to.FrameworkInstanceInfo\022\026\n\016self_module_"
    "id\030\002 \002(\r\022S\n\030module_add_resource_info\030\003 \003"
    "(\01321.FwmRcProto.EachModuleRequestOrRetur"
    "nResourceInfo\"2\n\026RequestTaskResourceAck\022"
    "\030\n\020exceed_module_id\030\001 \003(\r\"\310\001\n\022ReturnTask"
    "Resource\022B\n\027framework_instance_info\030\001 \002("
    "\0132!.FwmRcProto.FrameworkInstanceInfo\022\026\n\016"
    "self_module_id\030\002 \002(\r\022V\n\033module_return_re"
    "source_info\030\003 \003(\01321.FwmRcProto.EachModul"
    "eRequestOrReturnResourceInfo\"\200\001\n\nStopMod"
    ...
    "\'\n\rStopModuleAck\022\026\n\016stop_module_id\030\001 \003(\r"
    "\"k\n\rHeartBeatInfo\022B\n\027framework_instance_"
    "info\030\001 \002(\0132!.FwmRcProto.FrameworkInstanc"
    "eInfo\022\026\n\016self_module_id\030\002 \002(\r\"x\n\032CloseFr"
    "ameworkInstanceInfo\022B\n\027framework_instanc"
    "e_info\030\001 \002(\0132!.FwmRcProto.FrameworkInsta"
    "nceInfo\022\026\n\016self_module_id\030\002 \002(\r", 1911);
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_module_id:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 1, 8, input, this->mutable_module_id())));
        ...
        if (input->ExpectTag(8)) goto parse_module_id;
        if (input->ExpectAtEnd()) return true;
        break;
      }
...
::google::protobuf::uint8* RequestStartSlaveAck::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->module_id_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteUInt32ToArray(1, this->module_id(i), target);
  }
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_exceed_module_id:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 1, 8, input, this->mutable_exceed_module_id())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
        ...
        if (input->ExpectTag(8)) goto parse_exceed_module_id;
        if (input->ExpectAtEnd()) return true;
        break;
      }
...
void RequestTaskResourceAck::SerializeWithCachedSizes(
  ...
  for (int i = 0; i < this->exceed_module_id_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(
      1, this->exceed_module_id(i), output);
  }
...
::google::protobuf::uint8* RequestTaskResourceAck::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->exceed_module_id_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteUInt32ToArray(1, this->exceed_module_id(i), target);
  }
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // repeated uint32 stop_module_id = 1;
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_stop_module_id:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 1, 8, input, this->mutable_stop_module_id())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
        ...
        if (input->ExpectTag(8)) goto parse_stop_module_id;
        if (input->ExpectAtEnd()) return true;
        break;
      }
...
void StopModuleAck::SerializeWithCachedSizes(
  ...
  for (int i = 0; i < this->stop_module_id_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(
      1, this->stop_module_id(i), output);
  }
...
::google::protobuf::uint8* StopModuleAck::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->stop_module_id_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteUInt32ToArray(1, this->stop_module_id(i), target);
  }
