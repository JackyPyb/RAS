...
void protobuf_AssignDesc_RcSasProtocol_2eproto() {
  ...
  static const int AddBusinessEntry_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AddBusinessEntry, framework_instance_name_),
  ...
  static const int UpdateBusinessEntry_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(UpdateBusinessEntry, framework_instance_name_),
  ...
  static const int DeleteBusinessEntry_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DeleteBusinessEntry, framework_instance_name_),
  };
...
void protobuf_AddDesc_RcSasProtocol_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "BusinessEntry\022\037\n\027framework_instance_name"
    "\030\001 \002(\t\022\020\n\010entry_ip\030\002 \002(\t\022\022\n\nentry_port\030\003"
    " \002(\r\"\\\n\023UpdateBusinessEntry\022\037\n\027framework"
    "_instance_name\030\001 \002(\t\022\020\n\010entry_ip\030\002 \002(\t\022\022"
    "\n\nentry_port\030\003 \002(\r\"6\n\023DeleteBusinessEntr"
    "y\022\037\n\027framework_instance_name\030\001 \002(\t", 274);
...
#ifndef _MSC_VER
const int AddBusinessEntry::kFrameworkInstanceNameFieldNumber;
...
void AddBusinessEntry::SharedDtor() {
  if (framework_instance_name_ != &::google::protobuf::internal::kEmptyString) {
    delete framework_instance_name_;
  }
...
const AddBusinessEntry& AddBusinessEntry::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_RcSasProtocol_2eproto();  return *default_instance_;
}
...
void AddBusinessEntry::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (has_framework_instance_name()) {
      if (framework_instance_name_ != &::google::protobuf::internal::kEmptyString) {
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_framework_instance_name()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8String(
            this->framework_instance_name().data(), this->framework_instance_name().length(),
...
void AddBusinessEntry::SerializeWithCachedSizes(
  ...
  if (has_framework_instance_name()) {
    ...
    ::google::protobuf::internal::WireFormatLite::WriteString(
      1, this->framework_instance_name(), output);
  }
  ...
  if (has_framework_instance_name()) {
    ...
    target =
      ::google::protobuf::internal::WireFormatLite::WriteStringToArray(
        1, this->framework_instance_name(), target);
  }
...
void AddBusinessEntry::MergeFrom(const AddBusinessEntry& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_framework_instance_name()) {
      set_framework_instance_name(from.framework_instance_name());
    }
...
void AddBusinessEntry::Swap(AddBusinessEntry* other) {
  if (other != this) {
    std::swap(framework_instance_name_, other->framework_instance_name_);
...
#ifndef _MSC_VER
const int UpdateBusinessEntry::kFrameworkInstanceNameFieldNumber;
...
#ifndef _MSC_VER
const int DeleteBusinessEntry::kFrameworkInstanceNameFieldNumber;
#endif  // !_MSC_VER
